...
class MatrixExpression(SingleChildExpressionNode):
    ...
    def __getitem__(self, key: GetItem.KEY_TYPE) -> PolynomialExpression: ...
    @overload
...
class VectorExpression(MatrixExpression):
    ...
    def filter_predicate(self, predicate: FilterPredicate.PREDICATE_TYPE) -> VectorExpression: ...
...
class MonomialVectorExpression(VectorExpression):
    ...
    def filter_predicate(
        self, predicate: FilterPredicate.PREDICATE_TYPE
    ) -> MonomialVectorExpression: ...
